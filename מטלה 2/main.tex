...
\end{align*}
לשם הנוחות, נסמן את המסות ב 
$M_1, M_2, M_3, \dots, M_n$
כך ש 
$M_n$
היא המסה 
$m_i$
שמבקשים למצוא את התאוצה שלה.\\
את המשוואה הראשונה נקבל מחוק שימור החבל:\\


\begin{flalign*}
    &L=2\sum_{1}^{n} l_i \qquad\qquad\qquad \Bigg/\frac{d^2}{d^2 t}&&\\
    &0=\ddot{L}=2\sum_{1}^{n} A_i \quad\quad\quad\quad \Bigg/ :2 &&\\
    &\sum_{1}^{n} A_i = 0
\end{flalign*}
...
\begin{flalign*}
    &n \cdot 2T = \sum_{i\,=\,1}^{n} M_i g + \sum_{i\,=\,1}^{n} M_i A_i = 0&&\\
    &n\cdot(M_n g + M_n A_n) = \sum_{i\,=\,1}^{n} M_i g + \sum_{i\,=\,1}^{n} M_i A_i = 0&&\\
    &n M_n g + n M_n A_n = \sum_{i\,=\,1}^{n-1} M_i g + \sum_{i\,=\,1}^{n-1} M_i A_i + M_n g + M_n A_n&&
\end{flalign*}

\begin{flalign*}
    &(n-1) M_n g + (n-1) M_n A_n = \sum_{i\,=\,1}^{n-1} M_i g + \sum_{i\,=\,1}^{n-1} M_i A_i \qquad\qquad\qquad \Bigg/ : (n-1) M_n&&\\
    &A_n + g = \sum_{i\,=\,1}^{n-1} \frac{M_i g}{(n-1)M_n} + \sum_{i\,=\,1}^{n-1} \frac{M_i A_i}{(n-1)M_n}&&\\
    &A_n = \sum_{i\,=\,1}^{n-1} \frac{M_i g}{(n-1)M_n} + \sum_{i\,=\,1}^{n-1} \frac{M_i A_i}{(n-1)M_n} \;- \;g
\end{flalign*}

נסמן את סך כל הכוחות הממוצע הפועל על הגופים 1 עד $n-1$ ב 
$\Bar{F}$
ואת כח המשיכה הממוצע הפועל על הגופים 1 עד $n-1$ ב 
$\Bar{W}$.
\begin{flalign*}
    A_n = \frac{\Bar{W}}{M_n} + \frac{\Bar{F}}{M_n} \;- \;g
\end{flalign*}
